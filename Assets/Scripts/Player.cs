...
public class Player : MonoBehaviour
{
    ...
    void OnTriggerEnter2D(Collider2D collider) {
        if (collider.CompareTag("Enemy") || collider.CompareTag("Enemy Trail")) StartCoroutine(Die());
    }
